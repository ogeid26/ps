...
public class FunctionInterpreter_2 implements InterpreterStrategy_2{
    ...
    @Override
    public void interpret(Node node, HashMap<String,String> types, HashMap<String,String> values, ArrayList<String> constants) throws AssignationError, NotDefinedError, IncompatibilityError, ValueNotFoundError, EmptyContentError, ConstantVariableError, IllogicalConditionalError {
